...
public final class Main {
	...
	public static void main(String[] args){
		...
		//SolverOptimal s = new SolverOptimal(11);
		SolverSlack s = new SolverSlack(3);
		...
		for (int i = 0; i < random_count; ++i) {
			...
			//c.scramble("R2 D' 2R2 F2 2R2 f2 2R2 f2 U F2 R2 U R2 U' R2 D"); //B newP
			//c.scramble("F2 L' U' L F2 R' D R' D' r2 U2 2R2 u2 2R2 2U2"); //P newK
			...
			c.scramble("F U F' R2 F U' F' U' R2 U R2 U r2 U2 2R2 u2 2R2 2U2"); //S newQ
			...
			//c.scramble("2R2 F r' F' 2R2 U2 2R' U2 2R' U2 2R' U2 F r F' 2R2"); // adj ori p
			//c.scramble("");
