...
public class CubeSqsCoord {
	...
	public static byte prune_table_cencor5[Constants.N_SQS_CENTER_PERM*Constants.N_SQS_CORNER_PERM/2];
	public static byte prune_table_edgcor5[Constants.N_SQS_EDGE_PERM*Constants.N_SQS_CORNER_PERM/2];
	...
	public void do_move (int sqs_move_code){
		...
		m_cp96 = Tables.squares_move_corners (m_cp96, sqs_move_code);
		int cen0 = cen % 12;
		int cen1 = (cen/12) % 12;
		int cen2 = cen/(12*12); 
		m_cen12x12x12 = Tables.squares_move_centers (cen0, sqs_move_code, 0) +
